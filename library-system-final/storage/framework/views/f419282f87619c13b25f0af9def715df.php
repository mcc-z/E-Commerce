...
<div class="card">
    ...
    <div style="padding:8px 16px 16px;"><?php echo e($fines->links()); ?></div>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\library-system\library-system\resources\views/user/fines/index.blade.php ENDPATH**/ ?>