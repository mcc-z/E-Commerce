...
<div class="card">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-success btn-xs" onclick="openReturnModal('<?php echo e(route('admin.borrows.return', $borrow)); ?>')"><i class="fas fa-undo"></i> Return</button>
                        <?php endif; ?>
                    </td>
                </tr>
    ...
    <div style="padding:8px 16px 16px;"><?php echo e($borrows->links('pagination::simple-default')); ?></div>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Programs\E-Commerce\library-system-final\resources\views/admin/borrows/index.blade.php ENDPATH**/ ?>