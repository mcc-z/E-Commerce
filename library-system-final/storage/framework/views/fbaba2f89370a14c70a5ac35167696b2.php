...
<div class="card">
                    ...
                    <td>
                        <div style="display:flex;gap:4px;">
                            ...
                            <form action="<?php echo e(route('admin.books.destroy', $book)); ?>" method="POST"
                                ...
                                <button type="button" class="btn btn-danger btn-xs" onclick="openModal('<?php echo e(route('admin.books.destroy', $book)); ?>')"><i class="fas fa-trash"></i></button>
                            </form>
                        </div>
                    </td>
                </tr>
    ...
    <div style="padding:8px 16px 16px;"><?php echo e($books->links('pagination::simple-default')); ?></div>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Programs\E-Commerce\library-system-final\resources\views/admin/books/index.blade.php ENDPATH**/ ?>