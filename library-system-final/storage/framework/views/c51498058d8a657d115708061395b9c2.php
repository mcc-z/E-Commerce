...
<div style="max-width:680px;">
    ...
    <div class="card" style="margin-bottom:20px;">
        ...
        <div class="card-body">
            <form action="<?php echo e(route($profileRoutePrefix . '.profile.update')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div style="display:flex;align-items:center;gap:20px;margin-bottom:24px;padding-bottom:24px;border-bottom:1px solid var(--cream-2);">
                    <img src="<?php echo e($user->avatar_url); ?>" id="avatarPreview"
                ...
                <div class="form-grid-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" value="<?php echo e($user->email); ?>" disabled style="background:var(--cream);cursor:not-allowed;">
                    </div>
                </div>
                ...
                <div class="form-grid-2">
                    <div class="form-group">
                        ...
                        <input type="tel" name="phone" class="form-control" value="<?php echo e(old('phone', $user->phone)); ?>" placeholder="+1 (555) 000-0000">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Address</label>
                        <input type="text" name="address" class="form-control" value="<?php echo e(old('address', $user->address)); ?>" placeholder="123 Main Street, City">
                    </div>
                </div>
    ...
    <div class="card" style="margin-bottom:20px;">
        ...
        <div class="card-body">
            <form action="<?php echo e(route($profileRoutePrefix . '.profile.password')); ?>" method="POST">
                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                <div class="form-group">
...
<?php if (! (auth()->user()->isAdmin())): ?>
    ...
    <div id="deleteModal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:1000;align-items:center;justify-content:center;">
        <div style="background:white;border-radius:16px;padding:32px;max-width:380px;width:90%;margin:20px;">
            ...
            <form action="<?php echo e(route('user.profile.delete')); ?>" method="POST">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\library-system\library-system\resources\views/user/profile-edit.blade.php ENDPATH**/ ?>